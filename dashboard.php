...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="notification.php"><i class="fa fa-box-open"></i> Notification</a>
    ...
    <div class="content mt-5">
        <div class="container-fluid">
            <h2 class="welcome-header"><i class="fa fa-tachometer-alt"></i> Welcome, <?php echo htmlspecialchars($username); ?>!</h2>
            
            <!-- Cards for Quick Access -->
            <div class="card-grid mt-4">
                <div class="card">
                    <a href="lost_item.php">
                        <img src="./img/lostitem.png" alt="Report Lost Items" class="card-img-top">
                        <h5><i class="fa fa-box-open text-decoration: none"></i> Report Lost Items</h5>
                        <p>Report items that you have lost.</p>
                    </a>
                </div>

                <div class="card">
                    <a href="report.php">
                        <img src="./img/report_found.png" alt="Report Found Item" class="card-img-top">
                        <h5><i class="fa fa-pen"></i> Report Found Item</h5>
                        <p>Notify us of items you have found.</p>
                    </a>
                </div>
                
                <div class="card">
                    <a href="claim.php">
                        <img src="./img/claim.jpg" alt="Claim Items" class="card-img-top">
                        <h5><i class="fa fa-hand-holding"></i> Claim Items</h5>
                        <p>Claim found items that belong to you.</p>
                    </a>
                </div>

                <div class="card">
                    <a href="profile.php">
                        <img src="./img/Untitled-1.png" alt="Profile" class="card-img-top">
            ...
            <div class="testimonial mt-5">
                <p>"Lost & Found System has been a game-changer for our campus. It's easy to report and claim lost items!"</p>
                <h5>Jane Doe, Student</h5>
            </div>
        </div>
    </div>
