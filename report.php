...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Prepare SQL query
    $sql = "INSERT INTO report (user_id, item_name, item_description, lost_date, location, contact, item_image) 
    ...
    echo "<script>alert('Thank you for reporting the item you found, Take it to the security unit so we can post it!'); window.location.href = 'dashboard.php';</script>";
    exit();
}
?>
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="report.php" class="active"><i class="fa fa-pen"></i> Report Found Item</a>
    ...
    <div class="content">
        <div class="container-fluid">
            <h2 class="mb-4"><i class="fa fa-pen"></i> Report Found Item</h2>
            <div class="form-container mx-auto">
                <form id="reportForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="lostDate" class="form-label">Date Found</label>
